...
-->
<template>
    <textarea id="sceditorID" :name="name" :class="['block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:border-blue-500 text-area', $attrs.class, addClass]" :rows="rows" v-model="currentValue" v-bind="$attrs"><slot></slot></textarea>
</template>
        ...
        mounted() {
            window.onload = function() {
                ...
                sceditor.locale['de'] = {
                    ...
                    'Rows:': 'Zeilen',
                    'Cols:': 'Spalten',
                    'Insert a min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-sm text-left text-gray-500 dark:text-gray-400': 'Tabelle einfügen',
